...
#include "../Externals/Include/myHeader/propertyPanel.h"
...
void My_Init()
{
	...
	string numberStr[10];
	for (int i = 0; i < 10; i++) {
		numberStr[i] = "Image/number/number_" + to_string(i) + ".png";
	}
	m_PropertyPanel.init(shaderPopUpWindow.program, "Image/PanelPlayer1.png", "Image/PanelPlayer2.png", numberStr);
}
...
void My_Display()
{
	...
	m_PropertyPanel.draw(shaderPopUpWindow.program, 1650, 156543);
