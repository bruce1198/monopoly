...
void My_Init()
{
	...
	// Load shader file
	char** vertexShaderSource = loadShaderSource("card.vertex");
	char** fragmentShaderSource = loadShaderSource("card.fragment");
	...
	card = Card("Plane.obj", "card/33.png", 0);
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("Card"); // You cannot use OpenGL functions before this line; The OpenGL context must be created first by glutCreateWindow()!
#ifdef _MSC_VER
	glewInit();
#endif
	dumpInfo();
